 ...
 * <ol>
 * <li>Render thread draws with GL on its local EGLSurface, a window offscreenSurface it created.  The
 *     window offscreenSurface is backed by the SurfaceTexture from TextureVIew.
 ...
 *     is a window offscreenSurface visible to the compositor.
 * </ol>
    ...
    private static class Renderer extends Thread implements TextureView.SurfaceTextureListener {
        ...
        public void run() {
            while (true) {
                ...
                // Create an EGL offscreenSurface for our new SurfaceTexture.  We're not on the same
        ...
        private void doAnimation(WindowSurface eglSurface) {
            ...
            Log.d(TAG, "Animating " + width + "x" + height + " EGL offscreenSurface");
