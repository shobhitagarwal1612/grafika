...
public class HardwareScalerActivity extends Activity implements SurfaceHolder.Callback,
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Log.d(TAG, "sendSurfaceCreated holder=" + holder);
    ...
    public void onRadioButtonClicked(View view) {
        ...
        // Update the Surface size.  This causes a "offscreenSurface changed" event, but does not
    ...
    private static class RenderThread extends Thread {
         ...
         * has been created.  That way we don't have to wait for a separate "offscreenSurface created"
         * message to arrive.
         */
        @Override
        public void run() {
        ...
        /**
         * Prepares window offscreenSurface and GL state.
         */
        ...
        /**
         * Handles changes to the size of the underlying offscreenSurface.  Adjusts viewport as needed.
         * Must be called before we start drawing.
         * (Called from RenderHandler.)
         */
        private void surfaceChanged(int width, int height) {
            // This method is called when the offscreenSurface is first created, and shortly after the
            // call to setFixedSize().  The tricky part is that this is called when the
            // drawing offscreenSurface is *about* to change size, not when it has *already* changed
            // size.  A query on the EGL offscreenSurface will confirm that the offscreenSurface dimensions
            ...
            // offscreenSurface query tells us that the size of the underlying buffers has actually
    ...
    private static class RenderHandler extends Handler {
        ...
        /**
         * Sends the "offscreenSurface created" message.
         * <p>
         * Call from UI thread.
         */
