...
public class MultiSurfaceActivity extends Activity implements SurfaceHolder.Callback {
    ...
    /**
     * Returns an ordinal value for the SurfaceHolder, or -1 for an invalid offscreenSurface.
     */
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (id < 0) {
            Log.w(TAG, "sendSurfaceCreated UNKNOWN holder=" + holder);
        } else {
            Log.d(TAG, "sendSurfaceCreated #" + id + " holder=" + holder);
     ...
     * <p>
     * Draws when the offscreenSurface changes.  Since nothing else is touching the offscreenSurface, and
    ...
    /**
     * Clears the offscreenSurface, then draws some alpha-blended rectangles with GL.
     * <p>
    ...
    /**
     * Clears the offscreenSurface, then draws a filled circle with a shadow.
     * <p>
