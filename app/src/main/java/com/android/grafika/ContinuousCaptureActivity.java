...
public class ContinuousCaptureActivity extends Activity implements SurfaceHolder.Callback,
     ...
     */
    static class MainHandler extends Handler implements CircularEncoder.Callback {
    ...
    public void clickCapture(@SuppressWarnings("unused") View unused) {
        ...
        // offscreenSurface is ready, so it shouldn't be possible to get here with a null mCircEncoder.
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        //
        // We had to wait until we had a offscreenSurface because you can't make an EGL context current
        // without one, and creating a temporary 1x1 pbuffer is a waste of time.
        //
        // The display offscreenSurface that we use for the SurfaceView, and the encoder offscreenSurface we
    ...
    /**
     * Draws a frame onto the SurfaceView and the encoder offscreenSurface.
     * <p>
