 ...
 * records only the GL offscreenSurface (i.e. not the app UI, nav bar, status bar, or alert dialog).
 * <p>
...
public class RecordFBOActivity extends Activity implements SurfaceHolder.Callback,
     ...
     * SurfaceView's offscreenSurface is created.
     */
    ...
    private static class RenderThread extends Thread {
       ...
       /**
         ...
         * offscreenSurface for encoder input.
         */
